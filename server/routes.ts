...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  async function initializeData() {
    try {
      ...
      if (!cache.has("systems") || !cache.has("connections") || !cache.has("riskData")) {
        ...
        console.log(`Initialized ${systems.length} systems, ${allConnections.length} connections, and risk data`);
      }
    } catch (error) {
